<ul class="nav navbar-nav">
            ...
            <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-cubes"></i>&nbsp; ระบบคลังสินค้า</a>
              <ul class="dropdown-menu">
                ...
                <li><a href="index.php?content=order_event">		<i class="fa fa-upload"></i>&nbsp; เบิกสินค้าขายงานอีเว้นท์(ห้ามใช้)	</a></li>
                <li class="divider"></li>
          ...
          <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-shopping-bag"></i>&nbsp; ระบบขาย</a>
             ...
             <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-credit-card"></i>&nbsp; บัญชี</a>
              <ul class="dropdown-menu">
                ...
                <li class="divider"></li>
                <li class="dropdown-submenu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-archive"></i>&nbsp; ตรวจนับสินค้า</a>
                	<ul class="dropdown-menu">
            ...
            <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bar-chart"></i>&nbsp; รายงาน</a>
            	<ul class="dropdown-menu">
                    ...
                    <li class="dropdown-submenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bar-chart"></i>&nbsp; รายงาน ระบบขาย</a>
                    	<ul class="dropdown-menu">
                        	...
                        	<li><a href="index.php?content=sale_report_zone"><i class="fa fa-bar-chart"></i>&nbsp; สรุปยอดขาย แยกตามพื้นที่การขาย(ห้ามใช้)</a></li>
                            <li><a href="index.php?content=sale_report_employee"><i class="fa fa-bar-chart"></i>&nbsp; สรุปยอดขาย แยกตามพนักงานขาย(ห้ามใช้)</a></li>
                     ...
                     <li class="dropdown-submenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bar-chart"></i>&nbsp; รายงาน ระบบซื้อ</a>
                    	<ul class="dropdown-menu">
                            ...
                            <li><a href="index.php?content=sale_summary"><i class="fa fa-bar-chart"></i>&nbsp; รายงาน สรุปยอดการสั่งซื้อ แยกตามรายการสินค้า(ห้ามใช้)</a></li>
                    ...
                    <li class="dropdown-submenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bar-chart"></i>&nbsp; รายงาน ติดตาม</a>
                    	<ul class="dropdown-menu">
                        	<li><a href="index.php?content=report_stock_backlogs"><i class="fa fa-bar-chart"></i>&nbsp; รายงาน สินค้าค้างส่ง</a></li>
                            <li class="divider"></li>
             ...
             <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-cogs"></i>&nbsp; การตั้งค่า</a>
              <ul class="dropdown-menu">
              	<li><a href="index.php?content=config&general"><i class="fa fa-cogs"></i>&nbsp; ตั้งทั่วไป</a></li>
                <li><a href="index.php?content=config&product"><i class="fa fa-tags"></i>&nbsp; ตั้งค่าสินค้า</a></li>
                <li><a href="index.php?content=config&document"><i class="fa fa-file"></i>&nbsp; ตั้งค่าเอกสาร</a></li>
                <li><a href="index.php?content=config&popup"><i class="fa fa-bullhorn"></i>&nbsp; การแจ้งข่าว</a></li>
            	...
            	<ul class="dropdown-menu">
                    ...
                    <li class="dropdown-submenu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-users"></i>&nbsp; พนักงาน</a>
                      <ul class="dropdown-menu">
                        ...
                        <li><a href="index.php?content=event_sale"><i class="fa fa-user"></i>&nbsp; เพิ่ม/แก้ไข พนักงานขายอีเว้นท์(ห้ามใช้)</a></li>
                    ...
                    <li class="divider"></li>
                    <li><a href="index.php?content=product_db"><i class='fa fa-th'></i>&nbsp; รายงาน รายการสินค้า</a></li>
            	</ul>
            </li>
