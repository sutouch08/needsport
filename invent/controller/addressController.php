...
if( isset( $_GET['printOnlineAddressSheet'] ) && isset( $_GET['id_address'] ) )
{
	...
	/*********  Sender  ***********/
	$sender			 = '<div class="col-sm-12" style="border:solid 2px #ccc; border-radius:10px; padding:10px;">';
	...
	$sender     .= '<span style="font-size:14px; font-weight:normal;">โทร. '.$cPhone.'</span>';
	$sender     .= '</span>';
	//$sender     .= '<span style="display:block; margin-bottom:10px;"></span>';
	$sender			.= '<div style="position:relative; font-size:14px; font-weight:bold; display:block;">';
	$sender     .=   '<img src="'.$link.'" width="50px;" style="float:left; margin:0 5px 50px 0;" />';
	$sender     .=  '<span style="font-size:14px; font-weight:bold;">'.$cName.'</span>';
	$sender     .= '</div>';
	$sender			.= '<span style="font-size:12px; display:block;">'.$cAddress.'</span>';
	//$sender     .= '<br/>';
	$sender     .= '<span style="font-size:12px; display:block;"> รหัสไปรษณีย์  '.$cPostCode.'</span>';
